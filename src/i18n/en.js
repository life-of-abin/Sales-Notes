const en = {
  ...
  lossNotAllowedTitle: 'Selling at a Loss Not Allowed',
  lossNotAllowedDesc: 'Discount is too high! The final selling price ({finalPrice}) is lower than the wholesale purchase cost ({costPrice}). Selling in loss is not permitted.',
  belowCostError: 'Selling at a loss is not allowed! Purchase cost is {cost}',
  maxDiscountAllowed: 'Max allowed discount: {maxDiscount}',
  cannotSellInLoss: 'Cannot Sell at a Loss',
  customer: 'Customer',
